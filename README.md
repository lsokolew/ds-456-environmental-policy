...
Datasets Used:
- Power plant dataset: from ???. Used for power plant point locations, fuel types, output amounts, and other characteristics.
...
- eGRID: from EIA. Used for powerplant operational & retirement dates.
