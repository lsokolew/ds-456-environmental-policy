...
within_mile_school <- st_within(pp_points_proj, school_buffer)
points_sf$within_mile_school <- lengths(within_mile_school) > 0
points_sf$within_mile_school

school_buffer_half_mile <- st_buffer(school_proj, dist = (1609.34/2))
within_half_mile_school <- st_within(pp_points_proj, school_buffer_half_mile)
points_sf$within_half_mile_school <- lengths(within_half_mile_school) > 0
points_sf$within_half_mile_school



powerplant_buffer <- st_buffer(pp_points_proj, dist = (1609.34))
within_mile_school <- st_within(powerplant_buffer, school_proj)
points_sf$within_mile_school <- lengths(within_mile_school) > 0
points_sf$within_mile_school

school_buffer_half_mile <- st_buffer(school_proj, dist = (1609.34/2))
within_half_mile_school <- st_within(school_buffer_half_mile, pp_points_proj)
schools_sf$within_half_mile_school <- lengths(within_half_mile_school) > 0
points_sf$within_half_mile_school
...
within_mile_EJTract <- st_within(pp_points_proj, tracts_buffer)
